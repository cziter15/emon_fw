...
#define EMON_SENSOR_PROBES 15
#define EMON_SENSOR_UP_TRESHOLD 1.1f
#define EMON_SENSOR_DOWN_TRESHOLD 0.8f
#define EMON_TIMER_INTERVAL 100UL
#define EMON_SEC_TIMER 1000UL

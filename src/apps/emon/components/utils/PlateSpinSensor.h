...
namespace apps::emon::components::utils
{
	...
	class PlateSpinSensor
	{
		private:
			...
			static constexpr float RATIO_UPHILL_TRESHOLD{2.25f};				// Treshold for trend uphill detection.
			static constexpr float RATIO_STABLE_TRESHOLD{1.25f};			// Treshold for trend stabilization.
			...
			uint16_t trendProbesCount{0};									// How many trend probes we have in a row.
